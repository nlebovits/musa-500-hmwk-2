...
global_moran = c(global_moran(reg_data$LNMEDINC, reg_data$nb, reg_data$weights)$`I`,
                 global_moran_perm(spatial_lag_reg$residuals, reg_data$nb, reg_data$weights, alternative = "two.sided", 999)$`I`,
                 global_moran_perm(spatial_error_reg$residuals, reg_data$nb, reg_data$weights, alternative = "two.sided", 999)$`I`)
aic = c()
log_lik = c( , , NA, NA)

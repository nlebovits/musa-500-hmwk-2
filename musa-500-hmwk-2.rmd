...
The part with a spatial pattern can be thought of as some variable with a spatial component missing from the (first) regression
Note: λ is constrained between -1 and 1
